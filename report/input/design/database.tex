...
It may be useful to have these timestamps for administrative personnel, e.g. to see whether or not a user has joined a project group later than the other members. \todo{Jeg har ingen anelse om hvorfor vi har disse med}

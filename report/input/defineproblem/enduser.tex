...
To optain an understanding of the members of the project groups we consider two different approaches:  
\begin{itemize}
...
\morscaption{A graph showing how the end users representatives of project group members are spread between faculties and how much experienced they have with regard to LMSs}%
\label{fig:memPG}%
\end{figure}
...
\figref{fig:adminPG} shows the \admpers{} along with their faculty and LMS experience.

\begin{figure}%
\center
\includegraphics[scale=0.50]{images/administratorsOfPG}%
\morscaption{A graph showing how the end users representatives of the administrative tool are spread between faculties and how much experienced they have in regards to LMSs}%
\label{fig:adminPG}%
\end{figure}
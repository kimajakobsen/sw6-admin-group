...
In our system this can be accomplished by making a project group for both \subgroups{}, groups, and the semester.
...
\begin{figure}%
\missingfigure{Figure showing the difference between recursive tree structure and our implementation}
...
The virtual group room is implemented as a container for blocks, which made the inter-group integration less time consuming by having a common interface between the virtual group room and the blocks.

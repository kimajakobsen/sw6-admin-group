...
As stated in \chapref{chap:systemDef} we refrain our self from changing the core code of Moodle. 
...
The newly created context is only used in pages created in this sub-project and we can therefore create our own version of \fu{get\_context\_instance}. 

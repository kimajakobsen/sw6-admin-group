...
As described in sec somewhere we use the development 


\subsection{Adapting the Development Method}
...
\subsection{Utilizing the Development Method} %TDD MANGLER STADIG ET STED I DENNE SUBSECTION SKAL DEN VÆRE HER?

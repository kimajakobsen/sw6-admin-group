...
\label{chap:preface}
This report is the documentation of a bachelor project conducted in the period from \myDate{1}{2}{2012} to \myDate{4}{6}{2012} by the software student group sw608f12.
...
In the report the notation \moodlefile{/directory/file.ext} is used to specify a file in the source code. The path is relative in relation to the base directory of the Moodle installation. 

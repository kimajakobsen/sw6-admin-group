...
However, the second idea is closer to the way that Aalborg PBL is performed -- with a team working together on the project as described in \secref{sec:aaupbl}.

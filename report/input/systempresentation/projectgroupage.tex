...
\begin{figure}[h]
	\centering
		\includegraphics[width=\textwidth]{images/projectgroupwithedit2.png}
	\morscaption{The virtual group room. The red rectangle shows the project group block and the dashed lines shows the different areas on the page}
...
The red rectangle contains the members block and is created by our sub-group; we elaborate on the implementation of this in \secref{sub:membersblock}. 

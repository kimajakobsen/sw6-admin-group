...
For each project group there is a row in the list contain the following: The Shortname; which also works as a link to the page described in \secref{sec:projectGrpMem}, the long name of a project group, an edit button, and a delete button. 

...
\end{figure}
The code to add project groups to the navigation can be seen in \figref{moodlecodeextendingnavigation}. The code checks if something should be displayed at all and then run a foreach loop to print out the link to each group. 

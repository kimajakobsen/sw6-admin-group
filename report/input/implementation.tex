...
From section \secref{sec:architecture} we know there is three part(described as layers) which must be implemented by us. 
...
Another approach is to make a local plugin, which, as described in \secref{par:localplugin}, gives us basic functionality, such as database installation and the possibility to extend the inbuilt navigationblock. 

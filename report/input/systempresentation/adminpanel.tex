...
\end{figure}
The menu provides two links; One link to a list of all project groups, which are further described in \secref{sec:preListPg}, and one link to page where project groups can be edited. 

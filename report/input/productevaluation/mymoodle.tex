...
Since the members of a project group are all deleted whenever a project group is updated (described in \secref{sub:addedditprojectgroups}) these fields are worthless.

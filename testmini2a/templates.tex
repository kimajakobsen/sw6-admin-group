...
The local variable boatL is flipped to note that the boat has changed site. 
...
The updateOn and updateOff functions recives a personType as input. updateOn removes the personType from the relevant array.

...
%We will do this by listing the criteria that the different options are based on. 
...
\paragraph{MPBL}
In the interview with MPBL described in \secref{sub:mpblInterview}, they suggested to create a feeling of nearness, a virtual meeting place could be created. 

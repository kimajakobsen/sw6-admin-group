...
This inclusion is the implementation of the dependency between the admin component and the project group library component seen on figure \figref{fig:architecture}. 
...
If a member is highlight in the view when the form is submitted (as Kurt is in \figref{fig:moodlcgroupedit}) the role value is changed to supervisor (indicated by a value of ``1'') before the call to \fu{save\_or\_update\_projectgroup}.

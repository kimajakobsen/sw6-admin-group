...
There are code in project which is not included in functions and are not included in any unit tests, but will be tested using UI testing. 
UI testing is conducted by the developer too ensure that the functionality is as expected, and through the demo meetings where the system is tried out. 

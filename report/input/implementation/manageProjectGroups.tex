...
When \fu{save\_or\_update\_projectgroup} is used to update a project group the possible change in members is handled by removing every member from the project group and then adding the ones received as part of the arguments to the call.

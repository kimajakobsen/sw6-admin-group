...
\moodle{c}, however, provides functionality to render all blocks associated with a given page.
...
There is to be a functionality to hide or remove the members since students working in a physical group room might not need this and therefore prefer to focus on the other activities available in the virtual group room.\todo{Kim nævnte vist at der var en studerende der havde klaget over dette}

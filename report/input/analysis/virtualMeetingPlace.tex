...
The final design will be decided upon in the \nameref{chap:design} chapter. 
...
The virtual meeting place should be a hub where all central tools are available. It should be similar to the Aalborg group room concept and be available on a half-yearly basis.  
...
Moodles native group concept, described in \secref{sec:groups}, have its groups linked to courses just like SharePoint.   

...
The \subsystem{} that we are developing is called \administrationgroup{} and is briefly described in \secref{sec:decomposingSys}.
...
Recall from \secref{sec:aaupbl} that we define a project group to be a team of students working on a project.

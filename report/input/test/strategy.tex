...
A metric for determining how well some software is tested is code coverage. \todo{naar test results er skrevet saa skriv det her.}
...
Boundary values are identified as values of interest\todo{se bogen når den er med}.

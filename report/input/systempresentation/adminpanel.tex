...
\end{figure}
The menu provides two links: One link to a list of all project groups, which are further described in \secref{sec:preListPg}, and one link to a page where project groups can be edited. 
...
\label{sec:preListPg}
The list of project groups, seen on \figref{fig:moodleadminprojectgrouplist} provides an overview of all project groups. 
...
%% View a group
The project group members page, seen in \figref{fig:moodleprojectgroupoverview}, contains a list of the members of the group. 
...
\begin{figure}
	...
	\morscaption{A screen shot of the project group members page, which shows all current members of the project group}
\end{figure}
\FloatBarrier
...
The page is divided in four parts and can be seen on \figref{fig:moodleprojecgroupedit}. 
...
\begin{figure}
	...
	\morscaption{A screen shot of the add \& edit page}
\end{figure}
\FloatBarrier
...
The context systems hierarchical layout can be seen in \figref{fig:moodlecontexts}~\cite{moodlefilemoodlecontext}.
...
To determine whether or not a user has the capability to do certain actions the function \fu{has\_capability} is used~\cite{moodlerolesandmodules}.

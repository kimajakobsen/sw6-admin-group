...
From \secref{sec:architecture} we know that there is three part (described as components) which must be implemented by us -- the administration tool to manage project group, the project group, and the virtual group room. 
...
Another approach is to make a local plugin, which, as described in \secref{par:localplugin}, gives us basic functionality such as database installation and the possibility to extend the built-in navigation block. 

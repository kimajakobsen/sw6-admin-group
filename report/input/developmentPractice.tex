...
\myTop{An important part of this project is the collaboration between peer-groups, which is guided through a development method. 
...
Since we are having continuous integrations -- a \scrum{} practice -- and are passing the project on to new developers next year (described in item 5 in \secref{subsec:choosingmethod}), we want automated tests that can be run to ensure no regression in functionality. 

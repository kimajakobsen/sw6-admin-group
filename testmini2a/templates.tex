...
\begin{itemize}
	\item[\textbf{left}] Is an array with a list of all the person on the original shore(left)
	\item[\textbf{right}] Contains a list of all person on the taget shore(right)
\end{itemize}
